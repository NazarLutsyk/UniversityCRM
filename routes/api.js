...
let ClientStatusRouter = require('./client-status-router');
...
let ReportRouter = require('./report-router');
...
let PaymentStatusRouter = require('./payment-status-router');
...
router.use('/clients-statuses', authMiddleware.isLoggedIn, ClientStatusRouter);
...
router.use('/reports', authMiddleware.isLoggedIn, ReportRouter);
...
router.use('/payment-status', authMiddleware.isLoggedIn, guard.roles(ROLES.BOSS_ROLE, ROLES.MANAGER_ROLE), PaymentStatusRouter);
